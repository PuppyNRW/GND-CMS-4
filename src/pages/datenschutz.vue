...
<template>
  <div class="pt-28 mx-4 md:mx-8 leading-6 prose prose-lg prose-invert">
    ...
    <p>
      Puppy &amp; Friends NRW e.V.<br>
      c/o Aidshilfe D&uuml;sseldorf e.V.<br>
    ...
    <p>
      Telefon: +49 211 86 80 67 99<br>
      E-Mail: info@puppy.nrw
    </p>
    <p>
    ...
    <p>
      ...
      Einzugserm&auml;chtigung) zu &uuml;bermitteln, werden diese Daten
      zur Zahlungsabwicklung ben&ouml;tigt.
    </p>
    <p>
    ...
    <p>
      ...
      Zahlungsdaten, die Sie an uns &uuml;bermitteln, nicht von Dritten
      mitgelesen werden.
    </p>
    ...
    <h3>Google Forms</h3>
    <p>
      Wir haben Google Forms auf dieser Website eingebunden. Anbieter ist
      die die Google Ireland Limited, Gordon House, Barrow Street, Dublin
      4, Irland (nachfolgend Google).
    </p>
    <p>
      Google Forms erm&ouml;glicht es uns, Online-Formulare zu erstellen
      um Nachrichten, Anfragen und sonstige Eingaben unserer
      Websitebesucher strukturiert zu erfassen. Alle von Ihnen
      get&auml;tigten Eingaben werden auf den Servern von Google
      verarbeitet. Google Forms speichert ein Cookie in Ihrem Browser, das
      eine eindeutige ID enth&auml;lt (NID-Cookie). Dieses Cookie
      speichert verschiedene Informationen wie beispielsweise Ihre
      Spracheinstellungen.
    </p>
    <p>
      Der Einsatz von Google Forms erfolgt auf Grundlage unseres
      berechtigten Interesses an einer m&ouml;glichst nutzerfreundlichen
      Ermittlung Ihres Anliegens (Art. 6 Abs. 1 lit. f DSGVO). Sofern eine
      entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung
      ausschlie&szlig;lich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO
      und &sect; 25 Abs. 1 TTDSG, soweit die Einwilligung die Speicherung
      von Cookies oder den Zugriff auf Informationen im Endger&auml;t des
    ...
    <p>
      ...
      Sie uns zur L&ouml;schung auffordern, Ihre Einwilligung zur
      Speicherung widerrufen oder der Zweck f&uuml;r die Datenspeicherung
      entf&auml;llt (z.&nbsp;B. nach abgeschlossener Bearbeitung Ihrer
      Anfrage). Zwingende gesetzliche Bestimmungen &ndash; insbesondere
      Aufbewahrungsfristen &ndash; bleiben unber&uuml;hrt.
    ...
    <h3>MailerSend mit deaktivierter Erfolgsmessung</h3>
    <p>
      Diese Website nutzt die Dienste von MailerSend f&uuml;r den Versand
      von Newslettern und Tickets. Anbieter ist die MailerSend, Inc. (228
      Park Ave S, PMB 54955, New York, New York 10003-1502, US)
    </p>
    <p>
      MailerSend ist ein Dienst, mit dem u.a. der Versand von Newslettern
      organisiert werden kann. Wenn Sie Daten zum Zwecke des
      Newsletterbezugs eingeben (z.&nbsp;B. E-Mail-Adresse), werden diese
      auf den Servern von MailerSend in den USA gespeichert. Wir haben die
      Erfolgsmessung bei MailerSend deaktiviert, sodass MailerSend ihr
      Verhalten beim &Ouml;ffnen unserer Newsletter nicht auswerten wird.
    </p>
    <p>
      Wenn Sie nicht m&ouml;chten, dass Ihre Daten an MailerSend
    ...
    <p>
      ...
      finden Sie hier:
      <a
        href="https://www.mailersend.com/legal/"
        target="_blank"
        rel="noopener noreferrer"
      >https://www.mailersend.com/legal/</a>
      und
      <a
        href="https://www.mailersend.com/legal/data-processing-addendum"
        target="_blank"
        rel="noopener noreferrer"
      >https://www.mailersend.com/legal/data-processing-addendum</a>.
    </p>
    <p>
      ...
      <strong>Sie k&ouml;nnen der Speicherung widersprechen, sofern Ihre
    ...
    <p>
      ...
      6 Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TTDSG, soweit die
    ...
    <p>
      ...
      &uuml;ber die Inanspruchnahme dieser Website (Nutzungsdaten)
      erheben, verarbeiten und nutzen wir nur, soweit dies erforderlich
      ist, um dem Nutzer die Inanspruchnahme des Dienstes zu
      erm&ouml;glichen oder abzurechnen. Rechtsgrundlage hierf&uuml;r ist
      Art. 6 Abs. 1 lit. b DSGVO.
    </p>
    <p>
      Die erhobenen Kundendaten werden nach Abschluss des Auftrags oder
      Beendigung der Gesch&auml;ftsbeziehung und Ablauf der ggf.
    ...
    <p>
      ...
      Daten an das zur Lieferung betraute Transportunternehmen sowie an
      den mit der Zahlungsabwicklung beauftragten Zahlungsdienstleister
      weiter. Es werden nur solche Daten herausgegeben, die der jeweilige
      Dienstleister zur Erf&uuml;llung seiner Aufgabe ben&ouml;tigt.
      Rechtsgrundlage hierf&uuml;r ist Art. 6 Abs. 1 lit. b DSGVO, der die
      ...
      haben, werden wir Ihre E-Mail-Adresse an das mit der Lieferung
      betraute Transportunternehmen &uuml;bergeben, damit dieses Sie per
      E-Mail &uuml;ber den Versandstatus Ihrer Bestellung informieren
      kann; Sie k&ouml;nnen die Einwilligung jederzeit widerrufen.
    </p>
    <h3>
      Daten&shy;&uuml;bermittlung bei Vertragsschluss f&uuml;r
    ...
    <p>
      Eine weitergehende &Uuml;bermittlung der Daten erfolgt nicht bzw.
      nur dann, wenn Sie der &Uuml;bermittlung ausdr&uuml;cklich
    ...
    <p>
      ...
      ein. Wenn Sie einen Kauf bei uns t&auml;tigen, werden Ihre
      Zahlungsdaten (z.&nbsp;B. Name, Zahlungssumme, Kontoverbindung,
      Kreditkartennummer) vom Zahlungsdienstleister zum Zwecke der
      Zahlungsabwicklung verarbeitet. F&uuml;r diese Transaktionen gelten
      die jeweiligen Vertrags- und Datenschutzbestimmungen der jeweiligen
      Anbieter. Der Einsatz der Zahlungsdienstleister erfolgt auf
      Grundlage von Art. 6 Abs. 1 lit. b DSGVO (Vertragsabwicklung) sowie
      im Interesse eines m&ouml;glichst reibungslosen, komfortablen und
      sicheren Zahlungsvorgangs (Art. 6 Abs. 1 lit. f DSGVO). Soweit
      f&uuml;r bestimmte Handlungen Ihre Einwilligung abgefragt wird, ist
      Art. 6 Abs. 1 lit. a DSGVO Rechtsgrundlage der Datenverarbeitung;
    ...
    <h4>PayPal</h4>
    <p>
      Anbieter dieses Zahlungsdienstes ist PayPal (Europe) S.&agrave;.r.l.
      et Cie, S.C.A., 22-24 Boulevard Royal, L-2449 Luxembourg (im
      Folgenden &bdquo;PayPal&ldquo;).
    </p>
    <p>
      Die Daten&uuml;bertragung in die USA wird auf die
      Standardvertragsklauseln der EU-Kommission gest&uuml;tzt. Details
    ...
    <p>
      ...
      Cupertino, CA 95014, USA. Die Datenschutzerkl&auml;rung von Apple
      finden Sie unter:
      <a
    ...
    <p>
      ...
      Dublin 4, Irland. Die Datenschutzerkl&auml;rung von Google finden
      Sie hier:
      <a
