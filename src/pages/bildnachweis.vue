...
<template>
    <div class="pt-28 mx-4 md:mx-8 flex flex-col">
        <h1 class="text-primary text-5xl my-3">Bildnachweis</h1>
        <p class="text-2xl my-3">
            Liste aller Fotos, die nicht vom Gear'n'Dance Team gemacht worden
            sind.
        </p>
        <table class="text-2xl my-3">
            <thead class="border-b-2 border-white">
                <td class="font-light">Bild</td>
                <td class="font-light">Urheber</td>
                <td class="font-light">Profil</td>
                <td class="font-light">Datum</td>
            </thead>
            <tbody>
                <tr
