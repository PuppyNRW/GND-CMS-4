<template>
  <div class="pt-28 mx-4 md:mx-8 leading-6 prose prose-lg prose-invert">
    ...
    <h2>Dinge für die wir nicht haften können.</h2>
    ...
    <p>
      Unsere Website enthält sog. „externe Links“ (Verknüpfungen zu
      Websites Dritter), auf deren Inhalt wir keinen Einfluss haben und
      für den wir aus diesem Grund keine Gewähr übernehmen. Für die
      Inhalte und Richtigkeit der Informationen ist der jeweilige
      Informationsanbieter der verlinkten Websites verantwortlich. Als die
    ...
    <p>
      ...
      – nur mit dem vorherigen Einverständnis des Nutzers der Website.
    ...
    <h3>Widerspruch zur Verwendung veröffentlichter Kontaktdaten</h3>
    <p>
      Der Verwendung veröffentlichter Kontaktdaten durch Dritte zum Zwecke
      von Werbung wird ausdrücklich widersprochen. Wir behalten uns
      rechtliche Schritte für den Fall der unverlangten Zusendung von
      Werbeinformationen, z.B. durch Spam-Mails, vor.
    </p>
    <p>Quelle: Mustervorlage.net</p>
  </div>
</template>
